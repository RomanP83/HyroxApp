...
-- ==========================================================================
-- Migration 0027: idempotent macro directives
-- ==========================================================================
...
begin
  if p_directive not in ('auto_deload', 'trim_week', 'ramp_up') then raise exception 'invalid_directive'; end if;
  if p_multiplier <= 0 or p_multiplier > 1 then raise exception 'invalid_multiplier'; end if;
  ...
  if p_mark_deload then update plan_weeks set is_deload = true where id = p_week; end if;
  return true;
end;
$$;
...
-- ===========================================================================
-- Migration 0028: transactional session logging
-- ===========================================================================
